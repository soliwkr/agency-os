...
<template>
	...
	<UPopover v-else v-model:open="popoverOpen" class="relative" :ui="{ content: 'bg-default w-screen max-w-md p-4' }">
		...
		<template #content>
			<NuxtLink
				...
				class="relative flex p-4 leading-6 transition duration-150 rounded-panel group gap-x-6 hover:bg-muted"
			>
				<div
